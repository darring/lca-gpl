...
SOAP_SOURCE_STAMP("@(#) soapC.cpp ver 2.8.0 2010-12-01 22:43:24 GMT")
...
SOAP_FMAC3 void * SOAP_FMAC4 soap_getelement(struct soap *soap, int *type)
{
	...
	{	char **s;
		s = soap_in__ns3__FactoryType(soap, NULL, NULL, "xsd:QName");
		return s ? *s : NULL;
	}
	case SOAP_TYPE__ns3__QName:
	{	char **s;
		s = soap_in__ns3__QName(soap, NULL, NULL, "xsd:QName");
		return s ? *s : NULL;
	}
...
{	switch (p->type)
	...
	case SOAP_TYPE_ns4__MachineType_:
		if (p->size < 0)
			SOAP_DELETE((ns4__MachineType_*)p->ptr);
		else
			SOAP_DELETE_ARRAY((ns4__MachineType_*)p->ptr);
		break;
	case SOAP_TYPE_ns4__EILCommandStatus_:
		if (p->size < 0)
			SOAP_DELETE((ns4__EILCommandStatus_*)p->ptr);
		else
			SOAP_DELETE_ARRAY((ns4__EILCommandStatus_*)p->ptr);
		break;
	case SOAP_TYPE__ns1__GetCommandToExecute:
		if (p->size < 0)
			SOAP_DELETE((_ns1__GetCommandToExecute*)p->ptr);
		else
			SOAP_DELETE_ARRAY((_ns1__GetCommandToExecute*)p->ptr);
		break;
	case SOAP_TYPE__ns1__GetCommandToExecuteResponse:
		if (p->size < 0)
			SOAP_DELETE((_ns1__GetCommandToExecuteResponse*)p->ptr);
		else
	...
	case SOAP_TYPE__ns1__UpdateCommandStatus:
		if (p->size < 0)
			...
			SOAP_DELETE_ARRAY((_ns1__UpdateCommandStatus*)p->ptr);
		break;
	case SOAP_TYPE__ns1__UpdateCommandStatusResponse:
		if (p->size < 0)
			SOAP_DELETE((_ns1__UpdateCommandStatusResponse*)p->ptr);
		else
	...
	case SOAP_TYPE__ns1__InitiateClientCommands:
		if (p->size < 0)
			...
			SOAP_DELETE_ARRAY((_ns1__InitiateClientCommands*)p->ptr);
		break;
	case SOAP_TYPE__ns1__InitiateClientCommandsResponse:
		if (p->size < 0)
	...
	case SOAP_TYPE_ns4__MachineContext:
		if (p->size < 0)
			SOAP_DELETE((ns4__MachineContext*)p->ptr);
		else
			SOAP_DELETE_ARRAY((ns4__MachineContext*)p->ptr);
		break;
	case SOAP_TYPE_ns4__EILCommand:
		if (p->size < 0)
			SOAP_DELETE((ns4__EILCommand*)p->ptr);
		else
			SOAP_DELETE_ARRAY((ns4__EILCommand*)p->ptr);
		break;
	case SOAP_TYPE_ns5__ArrayOfstring:
		if (p->size < 0)
	...
	case SOAP_TYPE__ns5__ArrayOfKeyValueOfstringstring_KeyValueOfstringstring:
		if (p->size < 0)
			SOAP_DELETE((_ns5__ArrayOfKeyValueOfstringstring_KeyValueOfstringstring*)p->ptr);
		else
			SOAP_DELETE_ARRAY((_ns5__ArrayOfKeyValueOfstringstring_KeyValueOfstringstring*)p->ptr);
		break;
	case SOAP_TYPE_ns5__ArrayOfKeyValueOfstringstring:
		if (p->size < 0)
			SOAP_DELETE((ns5__ArrayOfKeyValueOfstringstring*)p->ptr);
		else
			SOAP_DELETE_ARRAY((ns5__ArrayOfKeyValueOfstringstring*)p->ptr);
		break;
	case SOAP_TYPE___ns1__GetCommandToExecute:
		if (p->size < 0)
			SOAP_DELETE((struct __ns1__GetCommandToExecute*)p->ptr);
		else
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_ns4__EILCommandStatus(struct soap *soap, const enum ns4__EILCommandStatus *a, const char *tag, const char *type)
{
	...
	if (soap_out_ns4__EILCommandStatus(soap, tag?tag:"ns4:EILCommandStatus", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_ns4__MachineType(struct soap *soap, const enum ns4__MachineType *a, const char *tag, const char *type)
{
	...
	if (soap_out_ns4__MachineType(soap, tag?tag:"ns4:MachineType", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
{
	(void)soap; /* appease -Wall -Werror */
	soap_default_string(soap, &this->_ns5__ArrayOfKeyValueOfstringstring_KeyValueOfstringstring::Key);
	soap_default_string(soap, &this->_ns5__ArrayOfKeyValueOfstringstring_KeyValueOfstringstring::Value);
}

void _ns5__ArrayOfKeyValueOfstringstring_KeyValueOfstringstring::soap_serialize(struct soap *soap) const
{
	(void)soap; /* appease -Wall -Werror */
	soap_serialize_string(soap, &this->_ns5__ArrayOfKeyValueOfstringstring_KeyValueOfstringstring::Key);
	soap_serialize_string(soap, &this->_ns5__ArrayOfKeyValueOfstringstring_KeyValueOfstringstring::Value);
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out__ns5__ArrayOfKeyValueOfstringstring_KeyValueOfstringstring(struct soap *soap, const char *tag, int id, const _ns5__ArrayOfKeyValueOfstringstring_KeyValueOfstringstring *a, const char *type)
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE__ns5__ArrayOfKeyValueOfstringstring_KeyValueOfstringstring), type))
		return soap->error;
	if (soap_out_string(soap, "ns5:Key", -1, &(a->_ns5__ArrayOfKeyValueOfstringstring_KeyValueOfstringstring::Key), ""))
		return soap->error;
	if (soap_out_string(soap, "ns5:Value", -1, &(a->_ns5__ArrayOfKeyValueOfstringstring_KeyValueOfstringstring::Value), ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
}
	...
	if (soap->body && !*soap->href)
	{
		...
		{	soap->error = SOAP_TAG_MISMATCH;
			if (soap_flag_Key1 && (soap->error == SOAP_TAG_MISMATCH || soap->error == SOAP_NO_TAG))
				if (soap_in_string(soap, "ns5:Key", &(a->_ns5__ArrayOfKeyValueOfstringstring_KeyValueOfstringstring::Key), "xsd:string"))
				{	soap_flag_Key1--;
					continue;
				}
			if (soap_flag_Value1 && (soap->error == SOAP_TAG_MISMATCH || soap->error == SOAP_NO_TAG))
				if (soap_in_string(soap, "ns5:Value", &(a->_ns5__ArrayOfKeyValueOfstringstring_KeyValueOfstringstring::Value), "xsd:string"))
				{	soap_flag_Value1--;
					continue;
				}
...
int _ns5__ArrayOfKeyValueOfstringstring_KeyValueOfstringstring::soap_put(struct soap *soap, const char *tag, const  char *type) const
{
	...
	if (this->soap_out(soap, tag?tag:"ns5:ArrayOfKeyValueOfstringstring-KeyValueOfstringstring", id, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC1 _ns5__ArrayOfKeyValueOfstringstring_KeyValueOfstringstring * SOAP_FMAC2 soap_instantiate__ns5__ArrayOfKeyValueOfstringstring_KeyValueOfstringstring(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(_ns5__ArrayOfKeyValueOfstringstring_KeyValueOfstringstring);
		if (size)
			*size = sizeof(_ns5__ArrayOfKeyValueOfstringstring_KeyValueOfstringstring);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(_ns5__ArrayOfKeyValueOfstringstring_KeyValueOfstringstring[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
int ns4__EILCommandStatus_::soap_put(struct soap *soap, const char *tag, const  char *type) const
{
	...
	if (this->soap_out(soap, tag?tag:"ns4:EILCommandStatus", id, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC1 ns4__EILCommandStatus_ * SOAP_FMAC2 soap_instantiate_ns4__EILCommandStatus_(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(ns4__EILCommandStatus_);
		if (size)
			*size = sizeof(ns4__EILCommandStatus_);
		((ns4__EILCommandStatus_*)cp->ptr)->soap = soap;
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(ns4__EILCommandStatus_[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
int ns4__MachineType_::soap_put(struct soap *soap, const char *tag, const  char *type) const
{
	...
	if (this->soap_out(soap, tag?tag:"ns4:MachineType", id, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC1 ns4__MachineType_ * SOAP_FMAC2 soap_instantiate_ns4__MachineType_(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(ns4__MachineType_);
		if (size)
			*size = sizeof(ns4__MachineType_);
		((ns4__MachineType_*)cp->ptr)->soap = soap;
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(ns4__MachineType_[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
SOAP_FMAC3 ns5__ArrayOfKeyValueOfstringstring * SOAP_FMAC4 soap_in_ns5__ArrayOfKeyValueOfstringstring(struct soap *soap, const char *tag, ns5__ArrayOfKeyValueOfstringstring *a, const char *type)
{
	...
	struct soap_blist *soap_blist_KeyValueOfstringstring1 = NULL;
	if (soap->body && !*soap->href)
	{
		for (;;)
		{	soap->error = SOAP_TAG_MISMATCH;
			/* transient soap skipped */
			if (soap->error == SOAP_TAG_MISMATCH && !soap_element_begin_in(soap, "ns5:KeyValueOfstringstring", 1, NULL))
			{	if (a->ns5__ArrayOfKeyValueOfstringstring::KeyValueOfstringstring == NULL)
				{	if (soap_blist_KeyValueOfstringstring1 == NULL)
						soap_blist_KeyValueOfstringstring1 = soap_new_block(soap);
					a->ns5__ArrayOfKeyValueOfstringstring::KeyValueOfstringstring = (_ns5__ArrayOfKeyValueOfstringstring_KeyValueOfstringstring *)soap_push_block(soap, soap_blist_KeyValueOfstringstring1, sizeof(_ns5__ArrayOfKeyValueOfstringstring_KeyValueOfstringstring));
					if (a->ns5__ArrayOfKeyValueOfstringstring::KeyValueOfstringstring == NULL)
						return NULL;
					_ns5__ArrayOfKeyValueOfstringstring_KeyValueOfstringstring p;
					memcpy(a->ns5__ArrayOfKeyValueOfstringstring::KeyValueOfstringstring, &p, sizeof(_ns5__ArrayOfKeyValueOfstringstring_KeyValueOfstringstring)); // a bit rough but portable
					a->ns5__ArrayOfKeyValueOfstringstring::KeyValueOfstringstring->soap_default(soap);
				}
				soap_revert(soap);
				if (soap_in__ns5__ArrayOfKeyValueOfstringstring_KeyValueOfstringstring(soap, "ns5:KeyValueOfstringstring", a->ns5__ArrayOfKeyValueOfstringstring::KeyValueOfstringstring, ""))
				{	a->ns5__ArrayOfKeyValueOfstringstring::__sizeKeyValueOfstringstring++;
					a->ns5__ArrayOfKeyValueOfstringstring::KeyValueOfstringstring = NULL;
					continue;
				}
			}
		...
		if (a->ns5__ArrayOfKeyValueOfstringstring::KeyValueOfstringstring)
			soap_pop_block(soap, soap_blist_KeyValueOfstringstring1);
		if (a->ns5__ArrayOfKeyValueOfstringstring::__sizeKeyValueOfstringstring)
			a->ns5__ArrayOfKeyValueOfstringstring::KeyValueOfstringstring = (_ns5__ArrayOfKeyValueOfstringstring_KeyValueOfstringstring *)soap_save_block(soap, soap_blist_KeyValueOfstringstring1, NULL, 1);
		else
		{	a->ns5__ArrayOfKeyValueOfstringstring::KeyValueOfstringstring = NULL;
			if (soap_blist_KeyValueOfstringstring1)
				soap_end_block(soap, soap_blist_KeyValueOfstringstring1);
		}
		if (soap_element_end_in(soap, tag))
			return NULL;
	}
...
int ns5__ArrayOfKeyValueOfstringstring::soap_put(struct soap *soap, const char *tag, const  char *type) const
{
	...
	if (this->soap_out(soap, tag?tag:"ns5:ArrayOfKeyValueOfstringstring", id, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC1 ns5__ArrayOfKeyValueOfstringstring * SOAP_FMAC2 soap_instantiate_ns5__ArrayOfKeyValueOfstringstring(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(ns5__ArrayOfKeyValueOfstringstring);
		if (size)
			*size = sizeof(ns5__ArrayOfKeyValueOfstringstring);
		((ns5__ArrayOfKeyValueOfstringstring*)cp->ptr)->soap = soap;
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(ns5__ArrayOfKeyValueOfstringstring[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
{
	this->soap = soap;
	soap_default_string(soap, &this->ns4__EILCommand::CommandExitMessage);
	soap_default_string(soap, &this->ns4__EILCommand::CommandName);
	this->ns4__EILCommand::CommandParameters = NULL;
	soap_default_string(soap, &this->ns4__EILCommand::CommandPath);
	soap_default_string(soap, &this->ns4__EILCommand::CommandResult);
	...
	soap_default_string(soap, &this->ns4__EILCommand::OperationID);
	soap_default_string(soap, &this->ns4__EILCommand::SetMachineType);
	this->xsd__anyType::__item = NULL;
	/* transient soap skipped */
}
...
{
	(void)soap; /* appease -Wall -Werror */
	soap_serialize_string(soap, &this->ns4__EILCommand::CommandExitMessage);
	soap_serialize_string(soap, &this->ns4__EILCommand::CommandName);
	soap_serialize_PointerTons5__ArrayOfKeyValueOfstringstring(soap, &this->ns4__EILCommand::CommandParameters);
	soap_serialize_string(soap, &this->ns4__EILCommand::CommandPath);
	soap_serialize_string(soap, &this->ns4__EILCommand::CommandResult);
	...
	soap_serialize_string(soap, &this->ns4__EILCommand::OperationID);
	soap_serialize_string(soap, &this->ns4__EILCommand::SetMachineType);
	/* transient soap skipped */
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns4__EILCommand(struct soap *soap, const char *tag, int id, const ns4__EILCommand *a, const char *type)
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns4__EILCommand), "ns4:EILCommand"))
		return soap->error;
	/* transient soap skipped */
	if (soap_out_string(soap, "ns4:CommandExitMessage", -1, &(a->ns4__EILCommand::CommandExitMessage), ""))
		return soap->error;
	if (soap_out_string(soap, "ns4:CommandName", -1, &(a->ns4__EILCommand::CommandName), ""))
		return soap->error;
	if (soap_out_PointerTons5__ArrayOfKeyValueOfstringstring(soap, "ns4:CommandParameters", -1, &(a->ns4__EILCommand::CommandParameters), ""))
		return soap->error;
	if (soap_out_string(soap, "ns4:CommandPath", -1, &(a->ns4__EILCommand::CommandPath), ""))
		return soap->error;
	if (soap_out_string(soap, "ns4:CommandResult", -1, &(a->ns4__EILCommand::CommandResult), ""))
		return soap->error;
	...
	if (soap_out_PointerToint(soap, "ns4:ExpectedTimeOut", -1, &(a->ns4__EILCommand::ExpectedTimeOut), ""))
		return soap->error;
	if (soap_out_string(soap, "ns4:OperationID", -1, &(a->ns4__EILCommand::OperationID), ""))
		return soap->error;
	if (soap_out_string(soap, "ns4:SetMachineType", -1, &(a->ns4__EILCommand::SetMachineType), ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
}
...
SOAP_FMAC3 ns4__EILCommand * SOAP_FMAC4 soap_in_ns4__EILCommand(struct soap *soap, const char *tag, ns4__EILCommand *a, const char *type)
{
	...
	size_t soap_flag___item2 = 1;
	size_t soap_flag_CommandExitMessage1 = 1;
	size_t soap_flag_CommandName1 = 1;
	size_t soap_flag_CommandParameters1 = 1;
	size_t soap_flag_CommandPath1 = 1;
	size_t soap_flag_CommandResult1 = 1;
	size_t soap_flag_CommandStatus1 = 1;
	size_t soap_flag_CommandSuccessful1 = 1;
	size_t soap_flag_ErrorCode1 = 1;
	size_t soap_flag_ExpectedTimeOut1 = 1;
	size_t soap_flag_OperationID1 = 1;
	size_t soap_flag_SetMachineType1 = 1;
	if (soap->body && !*soap->href)
	{
		for (;;)
		{	soap->error = SOAP_TAG_MISMATCH;
			...
			if (soap_flag_CommandExitMessage1 && (soap->error == SOAP_TAG_MISMATCH || soap->error == SOAP_NO_TAG))
				if (soap_in_string(soap, "ns4:CommandExitMessage", &(a->ns4__EILCommand::CommandExitMessage), "xsd:string"))
				{	soap_flag_CommandExitMessage1--;
					continue;
				}
			if (soap_flag_CommandName1 && (soap->error == SOAP_TAG_MISMATCH || soap->error == SOAP_NO_TAG))
				if (soap_in_string(soap, "ns4:CommandName", &(a->ns4__EILCommand::CommandName), "xsd:string"))
			...
			if (soap_flag_CommandPath1 && (soap->error == SOAP_TAG_MISMATCH || soap->error == SOAP_NO_TAG))
				if (soap_in_string(soap, "ns4:CommandPath", &(a->ns4__EILCommand::CommandPath), "xsd:string"))
				{	soap_flag_CommandPath1--;
					continue;
				}
			if (soap_flag_CommandResult1 && (soap->error == SOAP_TAG_MISMATCH || soap->error == SOAP_NO_TAG))
				if (soap_in_string(soap, "ns4:CommandResult", &(a->ns4__EILCommand::CommandResult), "xsd:string"))
			...
			if (soap_flag_OperationID1 && (soap->error == SOAP_TAG_MISMATCH || soap->error == SOAP_NO_TAG))
				if (soap_in_string(soap, "ns4:OperationID", &(a->ns4__EILCommand::OperationID), "xsd:string"))
				{	soap_flag_OperationID1--;
					continue;
				}
			if (soap_flag_SetMachineType1 && (soap->error == SOAP_TAG_MISMATCH || soap->error == SOAP_NO_TAG))
				if (soap_in_string(soap, "ns4:SetMachineType", &(a->ns4__EILCommand::SetMachineType), "xsd:string"))
...
int ns4__EILCommand::soap_put(struct soap *soap, const char *tag, const  char *type) const
{
	...
	if (this->soap_out(soap, tag?tag:"ns4:EILCommand", id, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC1 ns4__EILCommand * SOAP_FMAC2 soap_instantiate_ns4__EILCommand(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(ns4__EILCommand);
		if (size)
			*size = sizeof(ns4__EILCommand);
		((ns4__EILCommand*)cp->ptr)->soap = soap;
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(ns4__EILCommand[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
int ns4__MachineContext::soap_put(struct soap *soap, const char *tag, const  char *type) const
{
	...
	if (this->soap_out(soap, tag?tag:"ns4:MachineContext", id, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC1 ns4__MachineContext * SOAP_FMAC2 soap_instantiate_ns4__MachineContext(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(ns4__MachineContext);
		if (size)
			*size = sizeof(ns4__MachineContext);
		((ns4__MachineContext*)cp->ptr)->soap = soap;
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(ns4__MachineContext[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
{
	this->soap = soap;
	soap_default_string(soap, &this->_ns1__InitiateClientCommandsResponse::InitiateClientCommandsResult);
	/* transient soap skipped */
}
...
{
	(void)soap; /* appease -Wall -Werror */
	soap_serialize_string(soap, &this->_ns1__InitiateClientCommandsResponse::InitiateClientCommandsResult);
	/* transient soap skipped */
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out__ns1__InitiateClientCommandsResponse(struct soap *soap, const char *tag, int id, const _ns1__InitiateClientCommandsResponse *a, const char *type)
{
	...
	if (soap_out_string(soap, "ns1:InitiateClientCommandsResult", -1, &(a->_ns1__InitiateClientCommandsResponse::InitiateClientCommandsResult), ""))
		return soap->error;
	/* transient soap skipped */
	return soap_element_end_out(soap, tag);
}
...
SOAP_FMAC3 _ns1__InitiateClientCommandsResponse * SOAP_FMAC4 soap_in__ns1__InitiateClientCommandsResponse(struct soap *soap, const char *tag, _ns1__InitiateClientCommandsResponse *a, const char *type)
{
	...
	size_t soap_flag_InitiateClientCommandsResult1 = 1;
	if (soap->body && !*soap->href)
	{
		for (;;)
		{	soap->error = SOAP_TAG_MISMATCH;
			if (soap_flag_InitiateClientCommandsResult1 && (soap->error == SOAP_TAG_MISMATCH || soap->error == SOAP_NO_TAG))
				if (soap_in_string(soap, "ns1:InitiateClientCommandsResult", &(a->_ns1__InitiateClientCommandsResponse::InitiateClientCommandsResult), "xsd:string"))
...
int _ns1__InitiateClientCommandsResponse::soap_put(struct soap *soap, const char *tag, const  char *type) const
{
	...
	if (this->soap_out(soap, tag?tag:"ns1:InitiateClientCommandsResponse", id, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC1 _ns1__InitiateClientCommandsResponse * SOAP_FMAC2 soap_instantiate__ns1__InitiateClientCommandsResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(_ns1__InitiateClientCommandsResponse);
		if (size)
			*size = sizeof(_ns1__InitiateClientCommandsResponse);
		((_ns1__InitiateClientCommandsResponse*)cp->ptr)->soap = soap;
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(_ns1__InitiateClientCommandsResponse[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
void _ns1__InitiateClientCommands::soap_default(struct soap *soap)
{
	...
	soap_default_string(soap, &this->_ns1__InitiateClientCommands::ownrID);
	/* transient soap skipped */
}
...
void _ns1__InitiateClientCommands::soap_serialize(struct soap *soap) const
{
	...
	soap_serialize_string(soap, &this->_ns1__InitiateClientCommands::ownrID);
	/* transient soap skipped */
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out__ns1__InitiateClientCommands(struct soap *soap, const char *tag, int id, const _ns1__InitiateClientCommands *a, const char *type)
{
	...
	if (soap_out_PointerTons4__EILCommand(soap, "ns1:cmd", -1, &(a->_ns1__InitiateClientCommands::cmd), ""))
		return soap->error;
	if (soap_out_string(soap, "ns1:ownrID", -1, &(a->_ns1__InitiateClientCommands::ownrID), ""))
		return soap->error;
	/* transient soap skipped */
	return soap_element_end_out(soap, tag);
}
	...
	if (soap->body && !*soap->href)
	{
		...
		{	soap->error = SOAP_TAG_MISMATCH;
			...
			if (soap_flag_ownrID1 && (soap->error == SOAP_TAG_MISMATCH || soap->error == SOAP_NO_TAG))
				if (soap_in_string(soap, "ns1:ownrID", &(a->_ns1__InitiateClientCommands::ownrID), "xsd:string"))
				{	soap_flag_ownrID1--;
					continue;
				}
			/* transient soap skipped */
...
int _ns1__InitiateClientCommands::soap_put(struct soap *soap, const char *tag, const  char *type) const
{
	...
	if (this->soap_out(soap, tag?tag:"ns1:InitiateClientCommands", id, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC1 _ns1__InitiateClientCommands * SOAP_FMAC2 soap_instantiate__ns1__InitiateClientCommands(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(_ns1__InitiateClientCommands);
		if (size)
			*size = sizeof(_ns1__InitiateClientCommands);
		((_ns1__InitiateClientCommands*)cp->ptr)->soap = soap;
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(_ns1__InitiateClientCommands[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
SOAP_FMAC3 _ns1__UpdateCommandStatusResponse * SOAP_FMAC4 soap_in__ns1__UpdateCommandStatusResponse(struct soap *soap, const char *tag, _ns1__UpdateCommandStatusResponse *a, const char *type)
{
	...
	size_t soap_flag_UpdateCommandStatusResult1 = 1;
	if (soap->body && !*soap->href)
	{
		for (;;)
		{	soap->error = SOAP_TAG_MISMATCH;
...
int _ns1__UpdateCommandStatusResponse::soap_put(struct soap *soap, const char *tag, const  char *type) const
{
	...
	if (this->soap_out(soap, tag?tag:"ns1:UpdateCommandStatusResponse", id, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC1 _ns1__UpdateCommandStatusResponse * SOAP_FMAC2 soap_instantiate__ns1__UpdateCommandStatusResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(_ns1__UpdateCommandStatusResponse);
		if (size)
			*size = sizeof(_ns1__UpdateCommandStatusResponse);
		((_ns1__UpdateCommandStatusResponse*)cp->ptr)->soap = soap;
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(_ns1__UpdateCommandStatusResponse[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
int _ns1__UpdateCommandStatus::soap_put(struct soap *soap, const char *tag, const  char *type) const
{
	...
	if (this->soap_out(soap, tag?tag:"ns1:UpdateCommandStatus", id, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC1 _ns1__UpdateCommandStatus * SOAP_FMAC2 soap_instantiate__ns1__UpdateCommandStatus(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(_ns1__UpdateCommandStatus);
		if (size)
			*size = sizeof(_ns1__UpdateCommandStatus);
		((_ns1__UpdateCommandStatus*)cp->ptr)->soap = soap;
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(_ns1__UpdateCommandStatus[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
SOAP_FMAC3 _ns1__GetCommandToExecuteResponse * SOAP_FMAC4 soap_in__ns1__GetCommandToExecuteResponse(struct soap *soap, const char *tag, _ns1__GetCommandToExecuteResponse *a, const char *type)
{
	...
	size_t soap_flag_GetCommandToExecuteResult1 = 1;
	if (soap->body && !*soap->href)
	{
		for (;;)
		{	soap->error = SOAP_TAG_MISMATCH;
...
int _ns1__GetCommandToExecuteResponse::soap_put(struct soap *soap, const char *tag, const  char *type) const
{
	...
	if (this->soap_out(soap, tag?tag:"ns1:GetCommandToExecuteResponse", id, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC1 _ns1__GetCommandToExecuteResponse * SOAP_FMAC2 soap_instantiate__ns1__GetCommandToExecuteResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(_ns1__GetCommandToExecuteResponse);
		if (size)
			*size = sizeof(_ns1__GetCommandToExecuteResponse);
		((_ns1__GetCommandToExecuteResponse*)cp->ptr)->soap = soap;
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(_ns1__GetCommandToExecuteResponse[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
int _ns1__GetCommandToExecute::soap_put(struct soap *soap, const char *tag, const  char *type) const
{
	...
	if (this->soap_out(soap, tag?tag:"ns1:GetCommandToExecute", id, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC1 _ns1__GetCommandToExecute * SOAP_FMAC2 soap_instantiate__ns1__GetCommandToExecute(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(_ns1__GetCommandToExecute);
		if (size)
			*size = sizeof(_ns1__GetCommandToExecute);
		((_ns1__GetCommandToExecute*)cp->ptr)->soap = soap;
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(_ns1__GetCommandToExecute[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
{
	size_t soap_flag_ns1__InitiateClientCommands = 1;
	short soap_flag;
...
{
	register int id = 0;
	if (soap_out___ns1__InitiateClientCommands(soap, tag?tag:"-ns1:InitiateClientCommands", id, a, type))
		return soap->error;
	return SOAP_OK;
}
...
SOAP_FMAC1 struct __ns1__InitiateClientCommands * SOAP_FMAC2 soap_instantiate___ns1__InitiateClientCommands(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct __ns1__InitiateClientCommands);
		if (size)
			*size = sizeof(struct __ns1__InitiateClientCommands);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(struct __ns1__InitiateClientCommands[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
{
	size_t soap_flag_ns1__UpdateCommandStatus = 1;
	short soap_flag;
...
{
	register int id = 0;
	if (soap_out___ns1__UpdateCommandStatus(soap, tag?tag:"-ns1:UpdateCommandStatus", id, a, type))
		return soap->error;
	return SOAP_OK;
}
...
SOAP_FMAC1 struct __ns1__UpdateCommandStatus * SOAP_FMAC2 soap_instantiate___ns1__UpdateCommandStatus(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct __ns1__UpdateCommandStatus);
		if (size)
			*size = sizeof(struct __ns1__UpdateCommandStatus);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(struct __ns1__UpdateCommandStatus[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
{
	size_t soap_flag_ns1__GetCommandToExecute = 1;
	short soap_flag;
...
{
	register int id = 0;
	if (soap_out___ns1__GetCommandToExecute(soap, tag?tag:"-ns1:GetCommandToExecute", id, a, type))
		return soap->error;
	return SOAP_OK;
}
...
SOAP_FMAC1 struct __ns1__GetCommandToExecute * SOAP_FMAC2 soap_instantiate___ns1__GetCommandToExecute(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct __ns1__GetCommandToExecute);
		if (size)
			*size = sizeof(struct __ns1__GetCommandToExecute);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW(struct __ns1__GetCommandToExecute[n]);
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTo_ns1__InitiateClientCommandsResponse(struct soap *soap, _ns1__InitiateClientCommandsResponse *const*a, const char *tag, const char *type)
{
	...
	if (soap_out_PointerTo_ns1__InitiateClientCommandsResponse(soap, tag?tag:"ns1:InitiateClientCommandsResponse", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTo_ns1__InitiateClientCommands(struct soap *soap, _ns1__InitiateClientCommands *const*a, const char *tag, const char *type)
{
	...
	if (soap_out_PointerTo_ns1__InitiateClientCommands(soap, tag?tag:"ns1:InitiateClientCommands", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTo_ns1__UpdateCommandStatusResponse(struct soap *soap, _ns1__UpdateCommandStatusResponse *const*a, const char *tag, const char *type)
{
	...
	if (soap_out_PointerTo_ns1__UpdateCommandStatusResponse(soap, tag?tag:"ns1:UpdateCommandStatusResponse", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTo_ns1__UpdateCommandStatus(struct soap *soap, _ns1__UpdateCommandStatus *const*a, const char *tag, const char *type)
{
	...
	if (soap_out_PointerTo_ns1__UpdateCommandStatus(soap, tag?tag:"ns1:UpdateCommandStatus", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTo_ns1__GetCommandToExecuteResponse(struct soap *soap, _ns1__GetCommandToExecuteResponse *const*a, const char *tag, const char *type)
{
	...
	if (soap_out_PointerTo_ns1__GetCommandToExecuteResponse(soap, tag?tag:"ns1:GetCommandToExecuteResponse", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTo_ns1__GetCommandToExecute(struct soap *soap, _ns1__GetCommandToExecute *const*a, const char *tag, const char *type)
{
	...
	if (soap_out_PointerTo_ns1__GetCommandToExecute(soap, tag?tag:"ns1:GetCommandToExecute", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
{	char **p;
	p = soap_instring(soap, tag, a, type, SOAP_TYPE__ns3__FactoryType, 2, -1, -1);
	return p;
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put__ns3__FactoryType(struct soap *soap, char *const*a, const char *tag, const char *type)
{
	...
	if (soap_out__ns3__FactoryType(soap, tag?tag:"byte", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
{	char **p;
	p = soap_instring(soap, tag, a, type, SOAP_TYPE__ns3__QName, 2, -1, -1);
	return p;
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put__ns3__QName(struct soap *soap, char *const*a, const char *tag, const char *type)
{
	...
	if (soap_out__ns3__QName(soap, tag?tag:"byte", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTo_ns5__ArrayOfKeyValueOfstringstring_KeyValueOfstringstring(struct soap *soap, _ns5__ArrayOfKeyValueOfstringstring_KeyValueOfstringstring *const*a, const char *tag, const char *type)
{
	...
	if (soap_out_PointerTo_ns5__ArrayOfKeyValueOfstringstring_KeyValueOfstringstring(soap, tag?tag:"ns5:ArrayOfKeyValueOfstringstring-KeyValueOfstringstring", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTons4__EILCommandStatus(struct soap *soap, enum ns4__EILCommandStatus *const*a, const char *tag, const char *type)
{
	...
	if (soap_out_PointerTons4__EILCommandStatus(soap, tag?tag:"ns4:EILCommandStatus", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTons4__MachineType(struct soap *soap, enum ns4__MachineType *const*a, const char *tag, const char *type)
{
	...
	if (soap_out_PointerTons4__MachineType(soap, tag?tag:"ns4:MachineType", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTons5__ArrayOfKeyValueOfstringstring(struct soap *soap, ns5__ArrayOfKeyValueOfstringstring *const*a, const char *tag, const char *type)
{
	...
	if (soap_out_PointerTons5__ArrayOfKeyValueOfstringstring(soap, tag?tag:"ns5:ArrayOfKeyValueOfstringstring", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTons4__EILCommand(struct soap *soap, ns4__EILCommand *const*a, const char *tag, const char *type)
{
	...
	if (soap_out_PointerTons4__EILCommand(soap, tag?tag:"ns4:EILCommand", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTons4__MachineContext(struct soap *soap, ns4__MachineContext *const*a, const char *tag, const char *type)
{
	...
	if (soap_out_PointerTons4__MachineContext(soap, tag?tag:"ns4:MachineContext", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
