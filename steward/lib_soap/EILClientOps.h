/* EILClientOps.h
   Generated by wsdl2h 2.8.0 from http://172.16.3.12/CCMS/EILClientOperationsService.svc?wsdl and typemap.dat
   2011-02-22 19:24:09 GMT
...
//  Forward declaration of class _ns1__GetCommandToExecuteUsingMacAddress.
class _ns1__GetCommandToExecuteUsingMacAddress;

//  Forward declaration of class _ns1__GetCommandToExecuteUsingMacAddressResponse.
class _ns1__GetCommandToExecuteUsingMacAddressResponse;
...
//  Forward declaration of class _ns1__InitiateClientCommandsUsingMac.
class _ns1__InitiateClientCommandsUsingMac;

//  Forward declaration of class _ns1__InitiateClientCommandsUsingMacResponse.
class _ns1__InitiateClientCommandsUsingMacResponse;

//  Forward declaration of class _ns1__GetRDPConnectionString.
class _ns1__GetRDPConnectionString;

//  Forward declaration of class _ns1__GetRDPConnectionStringResponse.
class _ns1__GetRDPConnectionStringResponse;

//  Forward declaration of class _ns1__InitiateRDPRequest.
class _ns1__InitiateRDPRequest;

//  Forward declaration of class _ns1__InitiateRDPRequestResponse.
class _ns1__InitiateRDPRequestResponse;

//  Forward declaration of class _ns1__UpdateAssetInformation.
class _ns1__UpdateAssetInformation;

//  Forward declaration of class _ns1__UpdateAssetInformationResponse.
class _ns1__UpdateAssetInformationResponse;
...
/// Top-level root element "http://tempuri.org/":GetCommandToExecuteUsingMacAddress

/// "http://tempuri.org/":GetCommandToExecuteUsingMacAddress is a complexType.
class _ns1__GetCommandToExecuteUsingMacAddress
{ public:
/// Element ctx of type "http://schemas.datacontract.org/2004/07/EILClientManagmentService":MachineContext.
    ns4__MachineContext*                 ctx                            0;	///< Nullable pointer.
...
/// Top-level root element "http://tempuri.org/":GetCommandToExecuteUsingMacAddressResponse

/// "http://tempuri.org/":GetCommandToExecuteUsingMacAddressResponse is a complexType.
class _ns1__GetCommandToExecuteUsingMacAddressResponse
{ public:
/// Element GetCommandToExecuteUsingMacAddressResult of type "http://schemas.datacontract.org/2004/07/EILClientManagmentService":EILCommand.
    ns4__EILCommand*                     GetCommandToExecuteUsingMacAddressResult 0;	///< Nullable pointer.
/// A handle to the soap struct that manages this instance (automatically set)
    struct soap                         *soap                          ;
};
...
/// Top-level root element "http://tempuri.org/":InitiateClientCommandsUsingMac

/// "http://tempuri.org/":InitiateClientCommandsUsingMac is a complexType.
class _ns1__InitiateClientCommandsUsingMac
{ public:
/// Element ctx of type "http://schemas.datacontract.org/2004/07/EILClientManagmentService":MachineContext.
    ns4__MachineContext*                 ctx                            0;	///< Nullable pointer.
...
/// Top-level root element "http://tempuri.org/":InitiateClientCommandsUsingMacResponse

/// "http://tempuri.org/":InitiateClientCommandsUsingMacResponse is a complexType.
class _ns1__InitiateClientCommandsUsingMacResponse
{ public:
/// Element InitiateClientCommandsUsingMacResult of type xs:string.
    char*                                InitiateClientCommandsUsingMacResult 0;	///< Nullable pointer.
/// A handle to the soap struct that manages this instance (automatically set)
    struct soap                         *soap                          ;
};


/// Top-level root element "http://tempuri.org/":GetRDPConnectionString

/// "http://tempuri.org/":GetRDPConnectionString is a complexType.
class _ns1__GetRDPConnectionString
{ public:
/// A handle to the soap struct that manages this instance (automatically set)
    struct soap                         *soap                          ;
...
/// Top-level root element "http://tempuri.org/":GetRDPConnectionStringResponse

/// "http://tempuri.org/":GetRDPConnectionStringResponse is a complexType.
class _ns1__GetRDPConnectionStringResponse
{ public:
/// Element GetRDPConnectionStringResult of type xs:string.
    char*                                GetRDPConnectionStringResult   0;	///< Nullable pointer.
/// A handle to the soap struct that manages this instance (automatically set)
    struct soap                         *soap                          ;
};


/// Top-level root element "http://tempuri.org/":InitiateRDPRequest

/// "http://tempuri.org/":InitiateRDPRequest is a complexType.
class _ns1__InitiateRDPRequest
{ public:
/// Element envNum of type xs:string.
    char*                                envNum                         0;	///< Nullable pointer.
/// Element mcName of type xs:string.
    char*                                mcName                         0;	///< Nullable pointer.
/// Element macAddress of type xs:string.
    char*                                macAddress                     0;	///< Nullable pointer.
/// A handle to the soap struct that manages this instance (automatically set)
    struct soap                         *soap                          ;
};


/// Top-level root element "http://tempuri.org/":InitiateRDPRequestResponse

/// "http://tempuri.org/":InitiateRDPRequestResponse is a complexType.
class _ns1__InitiateRDPRequestResponse
{ public:
/// A handle to the soap struct that manages this instance (automatically set)
    struct soap                         *soap                          ;
...
/// Top-level root element "http://tempuri.org/":UpdateAssetInformation

/// "http://tempuri.org/":UpdateAssetInformation is a complexType.
class _ns1__UpdateAssetInformation
{ public:
/// Element hostName of type xs:string.
    char*                                hostName                       0;	///< Nullable pointer.
/// Element macAddr of type xs:string.
    char*                                macAddr                        0;	///< Nullable pointer.
/// Element xmlAssetInfo of type xs:string.
    char*                                xmlAssetInfo                   0;	///< Nullable pointer.
/// A handle to the soap struct that manages this instance (automatically set)
    struct soap                         *soap                          ;
};


/// Top-level root element "http://tempuri.org/":UpdateAssetInformationResponse

/// "http://tempuri.org/":UpdateAssetInformationResponse is a complexType.
class _ns1__UpdateAssetInformationResponse
{ public:
/// Element UpdateAssetInformationResult of type xs:boolean.
    bool*                                UpdateAssetInformationResult   0;	///< Optional element.
/// A handle to the soap struct that manages this instance (automatically set)
    struct soap                         *soap                          ;
};
...
/// Element mMacs of type "http://schemas.microsoft.com/2003/10/Serialization/Arrays":ArrayOfKeyValueOfstringstring.
    ns5__ArrayOfKeyValueOfstringstring*  mMacs                          0;	///< Nullable pointer.
...
//gsoap ns1  service port:	http://hfseilauto01.eil-infra.com/CCMS/EILClientOperationsService.svc 
...
@section WSHttpBinding_USCOREIEILClientOperations_operations Operations of Binding  "WSHttpBinding_USCOREIEILClientOperations"
  ...
  - @ref __ns1__GetCommandToExecuteUsingMacAddress

  - @ref __ns1__UpdateCommandStatus

  - @ref __ns1__InitiateClientCommands

  - @ref __ns1__InitiateClientCommandsUsingMac

  - @ref __ns1__GetRDPConnectionString

  - @ref __ns1__InitiateRDPRequest

  - @ref __ns1__UpdateAssetInformation

@section WSHttpBinding_USCOREIEILClientOperations_ports Endpoints of Binding  "WSHttpBinding_USCOREIEILClientOperations"

  - http://hfseilauto01.eil-infra.com/CCMS/EILClientOperationsService.svc
 ...
 *                                                                            *
 * Service Operation                                                          *
 *   __ns1__GetCommandToExecuteUsingMacAddress                                *
 *                                                                            *
\******************************************************************************/


/// Operation "__ns1__GetCommandToExecuteUsingMacAddress" of service binding "WSHttpBinding_USCOREIEILClientOperations"
...
Operation details:
  ...
  - SOAP action="http://tempuri.org/IEILClientOperations/GetCommandToExecuteUsingMacAddress"

C stub function (defined in soapClient.c[pp] generated by soapcpp2):
@code
  int soap_call___ns1__GetCommandToExecuteUsingMacAddress(
    struct soap *soap,
    NULL, // char *endpoint = NULL selects default endpoint for this operation
    NULL, // char *action = NULL selects default action for this operation
    // request parameters:
    _ns1__GetCommandToExecuteUsingMacAddress* ns1__GetCommandToExecuteUsingMacAddress,
    // response parameters:
    _ns1__GetCommandToExecuteUsingMacAddressResponse* ns1__GetCommandToExecuteUsingMacAddressResponse
  );
@endcode

C server function (called from the service dispatcher defined in soapServer.c[pp]):
@code
  int __ns1__GetCommandToExecuteUsingMacAddress(
    struct soap *soap,
    // request parameters:
    _ns1__GetCommandToExecuteUsingMacAddress* ns1__GetCommandToExecuteUsingMacAddress,
    // response parameters:
...
//gsoap ns1  service method-style:	GetCommandToExecuteUsingMacAddress document
//gsoap ns1  service method-encoding:	GetCommandToExecuteUsingMacAddress literal
//gsoap ns1  service method-action:	GetCommandToExecuteUsingMacAddress http://tempuri.org/IEILClientOperations/GetCommandToExecuteUsingMacAddress
int __ns1__GetCommandToExecuteUsingMacAddress(
    _ns1__GetCommandToExecuteUsingMacAddress* ns1__GetCommandToExecuteUsingMacAddress,	///< Request parameter
    _ns1__GetCommandToExecuteUsingMacAddressResponse* ns1__GetCommandToExecuteUsingMacAddressResponse	///< Response parameter
);
 ...
 *                                                                            *
 * Service Operation                                                          *
 *   __ns1__InitiateClientCommandsUsingMac                                    *
 *                                                                            *
\******************************************************************************/


/// Operation "__ns1__InitiateClientCommandsUsingMac" of service binding "WSHttpBinding_USCOREIEILClientOperations"
...
Operation details:
  ...
  - SOAP action="http://tempuri.org/IEILClientOperations/InitiateClientCommandsUsingMac"

C stub function (defined in soapClient.c[pp] generated by soapcpp2):
@code
  int soap_call___ns1__InitiateClientCommandsUsingMac(
    struct soap *soap,
    NULL, // char *endpoint = NULL selects default endpoint for this operation
    NULL, // char *action = NULL selects default action for this operation
    // request parameters:
    _ns1__InitiateClientCommandsUsingMac* ns1__InitiateClientCommandsUsingMac,
    // response parameters:
    _ns1__InitiateClientCommandsUsingMacResponse* ns1__InitiateClientCommandsUsingMacResponse
  );
@endcode

C server function (called from the service dispatcher defined in soapServer.c[pp]):
@code
  int __ns1__InitiateClientCommandsUsingMac(
    struct soap *soap,
    // request parameters:
    _ns1__InitiateClientCommandsUsingMac* ns1__InitiateClientCommandsUsingMac,
    // response parameters:
...
//gsoap ns1  service method-style:	InitiateClientCommandsUsingMac document
//gsoap ns1  service method-encoding:	InitiateClientCommandsUsingMac literal
//gsoap ns1  service method-action:	InitiateClientCommandsUsingMac http://tempuri.org/IEILClientOperations/InitiateClientCommandsUsingMac
int __ns1__InitiateClientCommandsUsingMac(
    _ns1__InitiateClientCommandsUsingMac* ns1__InitiateClientCommandsUsingMac,	///< Request parameter
    _ns1__InitiateClientCommandsUsingMacResponse* ns1__InitiateClientCommandsUsingMacResponse	///< Response parameter
);

/******************************************************************************\
 *                                                                            *
 * Service Operation                                                          *
 *   __ns1__GetRDPConnectionString                                            *
 *                                                                            *
\******************************************************************************/


/// Operation "__ns1__GetRDPConnectionString" of service binding "WSHttpBinding_USCOREIEILClientOperations"
...
Operation details:
  ...
  - SOAP action="http://tempuri.org/IEILClientOperations/GetRDPConnectionString"

C stub function (defined in soapClient.c[pp] generated by soapcpp2):
@code
  int soap_call___ns1__GetRDPConnectionString(
    struct soap *soap,
    NULL, // char *endpoint = NULL selects default endpoint for this operation
    NULL, // char *action = NULL selects default action for this operation
    // request parameters:
    _ns1__GetRDPConnectionString*       ns1__GetRDPConnectionString,
    // response parameters:
    _ns1__GetRDPConnectionStringResponse* ns1__GetRDPConnectionStringResponse
  );
@endcode

C server function (called from the service dispatcher defined in soapServer.c[pp]):
@code
  int __ns1__GetRDPConnectionString(
    struct soap *soap,
    // request parameters:
    _ns1__GetRDPConnectionString*       ns1__GetRDPConnectionString,
    // response parameters:
...
//gsoap ns1  service method-style:	GetRDPConnectionString document
//gsoap ns1  service method-encoding:	GetRDPConnectionString literal
//gsoap ns1  service method-action:	GetRDPConnectionString http://tempuri.org/IEILClientOperations/GetRDPConnectionString
int __ns1__GetRDPConnectionString(
    _ns1__GetRDPConnectionString*       ns1__GetRDPConnectionString,	///< Request parameter
    _ns1__GetRDPConnectionStringResponse* ns1__GetRDPConnectionStringResponse	///< Response parameter
);

/******************************************************************************\
 *                                                                            *
 * Service Operation                                                          *
 *   __ns1__InitiateRDPRequest                                                *
 *                                                                            *
\******************************************************************************/


/// Operation "__ns1__InitiateRDPRequest" of service binding "WSHttpBinding_USCOREIEILClientOperations"
...
Operation details:
  ...
  - SOAP action="http://tempuri.org/IEILClientOperations/InitiateRDPRequest"

C stub function (defined in soapClient.c[pp] generated by soapcpp2):
@code
  int soap_call___ns1__InitiateRDPRequest(
    struct soap *soap,
    NULL, // char *endpoint = NULL selects default endpoint for this operation
    NULL, // char *action = NULL selects default action for this operation
    // request parameters:
    _ns1__InitiateRDPRequest*           ns1__InitiateRDPRequest,
    // response parameters:
    _ns1__InitiateRDPRequestResponse*   ns1__InitiateRDPRequestResponse
  );
@endcode

C server function (called from the service dispatcher defined in soapServer.c[pp]):
@code
  int __ns1__InitiateRDPRequest(
    struct soap *soap,
    // request parameters:
    _ns1__InitiateRDPRequest*           ns1__InitiateRDPRequest,
    // response parameters:
...
//gsoap ns1  service method-style:	InitiateRDPRequest document
//gsoap ns1  service method-encoding:	InitiateRDPRequest literal
//gsoap ns1  service method-action:	InitiateRDPRequest http://tempuri.org/IEILClientOperations/InitiateRDPRequest
int __ns1__InitiateRDPRequest(
    _ns1__InitiateRDPRequest*           ns1__InitiateRDPRequest,	///< Request parameter
    _ns1__InitiateRDPRequestResponse*   ns1__InitiateRDPRequestResponse	///< Response parameter
);

/******************************************************************************\
 *                                                                            *
 * Service Operation                                                          *
 *   __ns1__UpdateAssetInformation                                            *
 *                                                                            *
\******************************************************************************/


/// Operation "__ns1__UpdateAssetInformation" of service binding "WSHttpBinding_USCOREIEILClientOperations"
...
Operation details:
  ...
  - SOAP action="http://tempuri.org/IEILClientOperations/UpdateAssetInformation"

C stub function (defined in soapClient.c[pp] generated by soapcpp2):
@code
  int soap_call___ns1__UpdateAssetInformation(
    struct soap *soap,
    NULL, // char *endpoint = NULL selects default endpoint for this operation
    NULL, // char *action = NULL selects default action for this operation
    // request parameters:
    _ns1__UpdateAssetInformation*       ns1__UpdateAssetInformation,
    // response parameters:
    _ns1__UpdateAssetInformationResponse* ns1__UpdateAssetInformationResponse
  );
@endcode

C server function (called from the service dispatcher defined in soapServer.c[pp]):
@code
  int __ns1__UpdateAssetInformation(
    struct soap *soap,
    // request parameters:
    _ns1__UpdateAssetInformation*       ns1__UpdateAssetInformation,
    // response parameters:
...
//gsoap ns1  service method-style:	UpdateAssetInformation document
//gsoap ns1  service method-encoding:	UpdateAssetInformation literal
//gsoap ns1  service method-action:	UpdateAssetInformation http://tempuri.org/IEILClientOperations/UpdateAssetInformation
int __ns1__UpdateAssetInformation(
    _ns1__UpdateAssetInformation*       ns1__UpdateAssetInformation,	///< Request parameter
    _ns1__UpdateAssetInformationResponse* ns1__UpdateAssetInformationResponse	///< Response parameter
);
...
@section ns1 Top-level root elements of schema "http://tempuri.org/"
  ...
  - <ns1:GetCommandToExecuteUsingMacAddress> @ref _ns1__GetCommandToExecuteUsingMacAddress
    @code
    // Reader (returns SOAP_OK on success):
    soap_read__ns1__GetCommandToExecuteUsingMacAddress(struct soap*, _ns1__GetCommandToExecuteUsingMacAddress*);
    // Writer (returns SOAP_OK on success):
    soap_write__ns1__GetCommandToExecuteUsingMacAddress(struct soap*, _ns1__GetCommandToExecuteUsingMacAddress*);
    @endcode

  - <ns1:GetCommandToExecuteUsingMacAddressResponse> @ref _ns1__GetCommandToExecuteUsingMacAddressResponse
    @code
    // Reader (returns SOAP_OK on success):
    soap_read__ns1__GetCommandToExecuteUsingMacAddressResponse(struct soap*, _ns1__GetCommandToExecuteUsingMacAddressResponse*);
    // Writer (returns SOAP_OK on success):
    soap_write__ns1__GetCommandToExecuteUsingMacAddressResponse(struct soap*, _ns1__GetCommandToExecuteUsingMacAddressResponse*);
    @endcode
  ...
  - <ns1:InitiateClientCommandsUsingMac> @ref _ns1__InitiateClientCommandsUsingMac
    @code
    // Reader (returns SOAP_OK on success):
    soap_read__ns1__InitiateClientCommandsUsingMac(struct soap*, _ns1__InitiateClientCommandsUsingMac*);
    // Writer (returns SOAP_OK on success):
    soap_write__ns1__InitiateClientCommandsUsingMac(struct soap*, _ns1__InitiateClientCommandsUsingMac*);
    @endcode

  - <ns1:InitiateClientCommandsUsingMacResponse> @ref _ns1__InitiateClientCommandsUsingMacResponse
    @code
    // Reader (returns SOAP_OK on success):
    soap_read__ns1__InitiateClientCommandsUsingMacResponse(struct soap*, _ns1__InitiateClientCommandsUsingMacResponse*);
    // Writer (returns SOAP_OK on success):
    soap_write__ns1__InitiateClientCommandsUsingMacResponse(struct soap*, _ns1__InitiateClientCommandsUsingMacResponse*);
    @endcode

  - <ns1:GetRDPConnectionString> @ref _ns1__GetRDPConnectionString
    @code
    // Reader (returns SOAP_OK on success):
    soap_read__ns1__GetRDPConnectionString(struct soap*, _ns1__GetRDPConnectionString*);
    // Writer (returns SOAP_OK on success):
    soap_write__ns1__GetRDPConnectionString(struct soap*, _ns1__GetRDPConnectionString*);
    @endcode

  - <ns1:GetRDPConnectionStringResponse> @ref _ns1__GetRDPConnectionStringResponse
    @code
    // Reader (returns SOAP_OK on success):
    soap_read__ns1__GetRDPConnectionStringResponse(struct soap*, _ns1__GetRDPConnectionStringResponse*);
    // Writer (returns SOAP_OK on success):
    soap_write__ns1__GetRDPConnectionStringResponse(struct soap*, _ns1__GetRDPConnectionStringResponse*);
    @endcode

  - <ns1:InitiateRDPRequest> @ref _ns1__InitiateRDPRequest
    @code
    // Reader (returns SOAP_OK on success):
    soap_read__ns1__InitiateRDPRequest(struct soap*, _ns1__InitiateRDPRequest*);
    // Writer (returns SOAP_OK on success):
    soap_write__ns1__InitiateRDPRequest(struct soap*, _ns1__InitiateRDPRequest*);
    @endcode

  - <ns1:InitiateRDPRequestResponse> @ref _ns1__InitiateRDPRequestResponse
    @code
    // Reader (returns SOAP_OK on success):
    soap_read__ns1__InitiateRDPRequestResponse(struct soap*, _ns1__InitiateRDPRequestResponse*);
    // Writer (returns SOAP_OK on success):
    soap_write__ns1__InitiateRDPRequestResponse(struct soap*, _ns1__InitiateRDPRequestResponse*);
    @endcode

  - <ns1:UpdateAssetInformation> @ref _ns1__UpdateAssetInformation
    @code
    // Reader (returns SOAP_OK on success):
    soap_read__ns1__UpdateAssetInformation(struct soap*, _ns1__UpdateAssetInformation*);
    // Writer (returns SOAP_OK on success):
    soap_write__ns1__UpdateAssetInformation(struct soap*, _ns1__UpdateAssetInformation*);
    @endcode

  - <ns1:UpdateAssetInformationResponse> @ref _ns1__UpdateAssetInformationResponse
    @code
    // Reader (returns SOAP_OK on success):
    soap_read__ns1__UpdateAssetInformationResponse(struct soap*, _ns1__UpdateAssetInformationResponse*);
    // Writer (returns SOAP_OK on success):
    soap_write__ns1__UpdateAssetInformationResponse(struct soap*, _ns1__UpdateAssetInformationResponse*);
    @endcode
